...
(cl:defclass <things_position> (roslisp-msg-protocol:ros-message)
  ((ball_pos
   ...
   (team_pos
    :reader team_pos
    :initarg :team_pos
    :type verysmall-msg:five_robot_pos
    :initform (cl:make-instance 'verysmall-msg:five_robot_pos))
   (team_vector
    :reader team_vector
    :initarg :team_vector
    :type verysmall-msg:five_robot_vector
    :initform (cl:make-instance 'verysmall-msg:five_robot_vector))
   (enemies_pos
    :reader enemies_pos
    :initarg :enemies_pos
    :type verysmall-msg:five_robot_pos
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<things_position>)))
  ...
  "e53313ec081a9c87ca55fbeaff276969")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'things_position)))
  "Returns md5sum for a message object of type 'things_position"
  "e53313ec081a9c87ca55fbeaff276969")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<things_position>)))
  ...
  (cl:format cl:nil "uint32[2]		 	        	ball_pos~%float64[2]        				ball_vector~%verysmall/five_robot_pos       	team_pos~%verysmall/five_robot_vector    	team_vector~%verysmall/five_robot_pos       	enemies_pos~%verysmall/five_robot_vector   	enemies_vector~%uint32[10]		 	        	robot_speed~%~%================================================================================~%MSG: verysmall/five_robot_pos~%uint32[2]    robot_pos_1~%uint32[2]    robot_pos_2~%uint32[2]    robot_pos_3~%uint32[2]    robot_pos_4~%uint32[2]    robot_pos_5~%================================================================================~%MSG: verysmall/five_robot_vector~%float64   robot_angle_vector_1~%float64   robot_angle_vector_2~%float64   robot_angle_vector_3~%float64   robot_angle_vector_4~%float64   robot_angle_vector_5~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'things_position)))
  "Returns full string definition for message of type 'things_position"
  (cl:format cl:nil "uint32[2]		 	        	ball_pos~%float64[2]        				ball_vector~%verysmall/five_robot_pos       	team_pos~%verysmall/five_robot_vector    	team_vector~%verysmall/five_robot_pos       	enemies_pos~%verysmall/five_robot_vector   	enemies_vector~%uint32[10]		 	        	robot_speed~%~%================================================================================~%MSG: verysmall/five_robot_pos~%uint32[2]    robot_pos_1~%uint32[2]    robot_pos_2~%uint32[2]    robot_pos_3~%uint32[2]    robot_pos_4~%uint32[2]    robot_pos_5~%================================================================================~%MSG: verysmall/five_robot_vector~%float64   robot_angle_vector_1~%float64   robot_angle_vector_2~%float64   robot_angle_vector_3~%float64   robot_angle_vector_4~%float64   robot_angle_vector_5~%~%"))
