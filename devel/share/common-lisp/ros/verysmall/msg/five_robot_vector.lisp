...
;//! \htmlinclude five_robot_vector.msg.html

(cl:defclass <five_robot_vector> (roslisp-msg-protocol:ros-message)
...
(cl:defclass five_robot_vector (<five_robot_vector>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <five_robot_vector>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'five_robot_vector)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name verysmall-msg:<five_robot_vector> is deprecated: use verysmall-msg:five_robot_vector instead.")))

(cl:ensure-generic-function 'robot_angle_vector_1-val :lambda-list '(m))
(cl:defmethod robot_angle_vector_1-val ((m <five_robot_vector>))
...
(cl:defmethod robot_angle_vector_2-val ((m <five_robot_vector>))
...
(cl:defmethod robot_angle_vector_3-val ((m <five_robot_vector>))
...
(cl:defmethod robot_angle_vector_4-val ((m <five_robot_vector>))
...
(cl:defmethod robot_angle_vector_5-val ((m <five_robot_vector>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <five_robot_vector>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <five_robot_vector>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<five_robot_vector>)))
  "Returns string type for a message object of type '<five_robot_vector>"
  "verysmall/five_robot_vector")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'five_robot_vector)))
  "Returns string type for a message object of type 'five_robot_vector"
  "verysmall/five_robot_vector")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<five_robot_vector>)))
  "Returns md5sum for a message object of type '<five_robot_vector>"
  "46d2ecd06a68bed7c3b95711f5808fee")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'five_robot_vector)))
  "Returns md5sum for a message object of type 'five_robot_vector"
  "46d2ecd06a68bed7c3b95711f5808fee")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<five_robot_vector>)))
  "Returns full string definition for message of type '<five_robot_vector>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'five_robot_vector)))
  "Returns full string definition for message of type 'five_robot_vector"
  (cl:format cl:nil "float64   robot_angle_vector_1~%float64   robot_angle_vector_2~%float64   robot_angle_vector_3~%float64   robot_angle_vector_4~%float64   robot_angle_vector_5~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <five_robot_vector>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <five_robot_vector>))
  "Converts a ROS message object to a list"
  (cl:list 'five_robot_vector
