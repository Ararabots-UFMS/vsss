...
;//! \htmlinclude 5_robot_pos.msg.html

(cl:defclass <5_robot_pos> (roslisp-msg-protocol:ros-message)
  ((robot_pos_1
    :reader robot_pos_1
    :initarg :robot_pos_1
...
(cl:defclass 5_robot_pos (<5_robot_pos>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <5_robot_pos>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m '5_robot_pos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name verysmall-msg:<5_robot_pos> is deprecated: use verysmall-msg:5_robot_pos instead.")))

(cl:ensure-generic-function 'robot_pos_1-val :lambda-list '(m))
(cl:defmethod robot_pos_1-val ((m <5_robot_pos>))
...
(cl:defmethod robot_pos_2-val ((m <5_robot_pos>))
...
(cl:defmethod robot_pos_3-val ((m <5_robot_pos>))
...
(cl:defmethod robot_pos_4-val ((m <5_robot_pos>))
...
(cl:defmethod robot_pos_5-val ((m <5_robot_pos>))
  ...
  (robot_pos_5 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <5_robot_pos>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <5_robot_pos>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<5_robot_pos>)))
  "Returns string type for a message object of type '<5_robot_pos>"
  "verysmall/5_robot_pos")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '5_robot_pos)))
  "Returns string type for a message object of type '5_robot_pos"
  "verysmall/5_robot_pos")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<5_robot_pos>)))
  "Returns md5sum for a message object of type '<5_robot_pos>"
  "2fb152bde934739c2e0092eef499be2d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '5_robot_pos)))
  "Returns md5sum for a message object of type '5_robot_pos"
  "2fb152bde934739c2e0092eef499be2d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<5_robot_pos>)))
  "Returns full string definition for message of type '<5_robot_pos>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '5_robot_pos)))
  "Returns full string definition for message of type '5_robot_pos"
  (cl:format cl:nil "uint32[2]    robot_pos_1~%uint32[2]    robot_pos_2~%uint32[2]    robot_pos_3~%uint32[2]    robot_pos_4~%uint32[2]    robot_pos_5~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <5_robot_pos>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <5_robot_pos>))
