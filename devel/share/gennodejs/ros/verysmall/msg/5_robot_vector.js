...
class 5_robot_vector {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new 5_robot_vector(null);
  ...
  static datatype() {
    ...
    return 'verysmall/5_robot_vector';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new 5_robot_vector(null);
