...
#include <verysmall/5_robot_pos.h>
#include <verysmall/5_robot_vector.h>
#include <verysmall/5_robot_pos.h>
#include <verysmall/5_robot_vector.h>
...
struct things_position_
{
  ...
  _ball_vector_type ball_vector;
   ...
   typedef  ::verysmall::5_robot_pos_<ContainerAllocator>  _team_pos_type;
  _team_pos_type team_pos;

   typedef  ::verysmall::5_robot_vector_<ContainerAllocator>  _team_vector_type;
  _team_vector_type team_vector;

   typedef  ::verysmall::5_robot_pos_<ContainerAllocator>  _enemies_pos_type;
  _enemies_pos_type enemies_pos;

   typedef  ::verysmall::5_robot_vector_<ContainerAllocator>  _enemies_vector_type;
...
struct MD5Sum< ::verysmall::things_position_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xf1165e4b4a4a1a01ULL;
  static const uint64_t static_value2 = 0x85744f35adc81017ULL;
};
...
struct Printer< ::verysmall::things_position_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::verysmall::things_position_<ContainerAllocator>& v)
  {
    ...
    s << indent << "team_pos: ";
    s << std::endl;
    Printer< ::verysmall::5_robot_pos_<ContainerAllocator> >::stream(s, indent + "  ", v.team_pos);
    s << indent << "team_vector: ";
    s << std::endl;
    Printer< ::verysmall::5_robot_vector_<ContainerAllocator> >::stream(s, indent + "  ", v.team_vector);
    s << indent << "enemies_pos: ";
    s << std::endl;
    Printer< ::verysmall::5_robot_pos_<ContainerAllocator> >::stream(s, indent + "  ", v.enemies_pos);
    s << indent << "enemies_vector: ";
    s << std::endl;
    Printer< ::verysmall::5_robot_vector_<ContainerAllocator> >::stream(s, indent + "  ", v.enemies_vector);
