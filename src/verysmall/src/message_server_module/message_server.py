...
class MessageServer:
    ...
    def __init__(self, max_sockets_capacity: int = 5,
        ...
        self.service = rospy.Service('message_server_service',
                       message_server_service, 
                       self._service_request_handler)
        
        self.topic_publisher = MessageServerPublisher()

        from ROS.message_server_subscriber import MessageServerSubscriber
        self.topic_subscriber = MessageServerSubscriber(self)
